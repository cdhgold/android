...
GROUP BY A.SLAN_CD, A.VPS_ETA_DT, D.SHP_ID_NO, D.VST_NO, D.MVMT_SEQ, D.PNM_VSL_OPR_CD, D.PNM_ORG_CD, D.PNM_DEST_CD,	D.EDI_SND_DT, D.EDI_SND_SEQ, D.EDI_SND_USR_ID